    ...
    <>
      <div className="isolate bg-white -z-10">
        <div className="absolute inset-x-0 top-[-10rem] -z-10 transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]">
          <svg
            className="relative left-[calc(50%-11rem)] -z-30 h-[21.1875rem] max-w-none -translate-x-1/2 rotate-[30deg] sm:left-[calc(50%-30rem)] sm:h-[42.375rem]"
            ...
            <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
              <div className="text-center">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Welcome to the online portal of our college library
                </p>
      ...
      <div className="bg-white">
        <div className="max-w-xl items-center text-center mx-auto">
          <label
            htmlFor="Search"
            className="block text-lg font-xl text-gray-800"
          >
            Find your next read
          </label>
        ...
        <div>
          <div className="mx-auto max-w-2xl py-16 px-4 sm:py-24 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            {/* <div className="text-xl tracking-tight text-center mt-10 mb-10 text-gray-700">
            Sign in to view
          </div> */}
